...
public class SheetsQuickstart {
  ...
  private static void waitForBrowserReauth(Credential cred) {
  ...
  public static void main(String... args) throws IOException, GeneralSecurityException {
    ...
    // need to validate if the creds are good and not expired

    // sheet updating logic...
    final String spreadsheetId = "1JPKxB2MFNG3DMxOaQy_hUE5cMZfvL2e7UQwqirP35gw";

    // test read
    final String range = "TestSheet!A2:K2";
    ...
    appendRowToJobSearches(HTTP_TRANSPORT, googleCreds, spreadsheetId, range, row1);
  }
  ...
  public static void appendRowToJobSearches(HttpTransport HTTP_TRANSPORT, Credential credential,
      final String sheetId, final String range, List<Object> newRowValues)
